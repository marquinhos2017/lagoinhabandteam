...
class VerLetraUser extends StatefulWidget {
  final String documentId;
  final bool isAdmin;

  VerLetraUser({required this.documentId, required this.isAdmin});

  @override
  _VerCifraUserState createState() => _VerCifraUserState();
}

class _VerCifraUserState extends State<VerLetraUser> {
